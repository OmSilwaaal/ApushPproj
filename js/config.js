...
const CONFIG = {
  ...
  UNITS: {
    /* US Forces */
    INFANTRY:     { id:'INFANTRY',     name:'Rifle Squad (M16A1)',      faction:'us', hp:100, atk:25, def:15, spd:1.6, sight:4, noise:2.0, cost:10, cdSec:5,  symbol:'I', flying:false, limited:false, range:1,  attackRate:1.5, accuracy:0.70 },
    ...
    SHARPSHOOTER: { id:'SHARPSHOOTER', name:'Scout Sniper (XM21)',       faction:'us', hp:30,  atk:95, def:4,  spd:1.3, sight:10,noise:0.2, cost:15, cdSec:14, symbol:'X', flying:false, limited:false, range:10, attackRate:0.28,accuracy:0.90 },
    ...
    ARTILLERY:    { id:'ARTILLERY',    name:'M102 Howitzer Battery',     faction:'us', hp:80,  atk:90, def:5,  spd:0.8, sight:2, noise:8.0, cost:25, cdSec:12, symbol:'A', flying:false, limited:false, range:8,  attackRate:0.2, accuracy:0.80, needsCoords:true },
    ARMOR:        { id:'ARMOR',        name:'M48A3 Patton',              faction:'us', hp:200, atk:60, def:55, spd:1.3, sight:3, noise:5.0, cost:40, cdSec:15, symbol:'T', flying:false, limited:false, range:1,  attackRate:0.6, accuracy:0.68 },
    HELICOPTER:   { id:'HELICOPTER',   name:'UH-1C Huey Gunship',        faction:'us', hp:60,  atk:45, def:10, spd:4.0, sight:6, noise:4.0, cost:30, cdSec:10, symbol:'H', flying:true,  limited:false, range:2,  attackRate:2.0, accuracy:0.62 },
    RECON:        { id:'RECON',        name:'LRRP Team',                 faction:'us', hp:35,  atk:10, def:5,  spd:2.0, sight:7, noise:0.5, cost:0,  cdSec:6,  symbol:'R', flying:false, limited:true,  range:1,  attackRate:0.8, accuracy:0.58 },
    AIRSTRIKE:    { id:'AIRSTRIKE',    name:'F-105D Thunderchief',       faction:'us', hp:999, atk:150,def:999,spd:0,   sight:6, noise:9.0, cost:50, cdSec:18, symbol:'F', flying:true,  limited:false, range:0,  oneshot:true, aoe:1.5, needsCoords:false },
    NAPALM:       { id:'NAPALM',       name:'AN/M47 Napalm Strike',      faction:'us', hp:999, atk:100,def:999,spd:0,   sight:4, noise:8.0, cost:35, cdSec:22, symbol:'N', flying:true,  limited:false, range:0,  oneshot:true, aoe:2.5, burns:true, needsCoords:false },
    AGENT_ORANGE: { id:'AGENT_ORANGE', name:'Agent Orange (Ranch Hand)', faction:'us', hp:999, atk:20, def:999,spd:0,   sight:0, noise:5.0, cost:35, cdSec:30, symbol:'O', flying:true,  limited:false, range:0,  oneshot:true, aoe:3.5, defoliate:true, opinionDmg:15, needsCoords:false },
    NAVAL:        { id:'NAVAL',        name:'Naval Gunfire (7th Fleet)', faction:'us', hp:999, atk:100,def:999,spd:0,   sight:0, noise:7.0, cost:45, cdSec:20, symbol:'B', flying:false, limited:false, range:10, oneshot:true, aoe:2,   needsCoords:false },

    /* VC/NVA Forces */
    VC_SQUAD:   { id:'VC_SQUAD',   name:'VC Guerrilla (AK-47)',      faction:'vc', hp:80,  atk:30, def:12, spd:1.3, sight:3, noise:1.0, symbol:'V', hidden:true,  tunnelCapable:true, attackRate:1.4, accuracy:0.62 },
    VC_SNIPER:  { id:'VC_SNIPER',  name:'VC Sniper (Mosin-Nagant)',  faction:'vc', hp:40,  atk:70, def:6,  spd:1.0, sight:7, noise:0.2, symbol:'S', hidden:true,  range:7, attackRate:0.6, accuracy:0.88 },
    VC_MORTAR:  { id:'VC_MORTAR',  name:'VC Mortar Team (82mm)',     faction:'vc', hp:55,  atk:85, def:8,  spd:0.8, sight:3, noise:4.0, symbol:'M', hidden:true,  range:7, attackRate:0.3, accuracy:0.80 },
    ...
    VC_COMMAND: { id:'VC_COMMAND', name:'VC Cadre (Political Off.)', faction:'vc', hp:110, atk:30, def:18, spd:1.2, sight:5, noise:0.5, symbol:'C', hidden:true,  attackRate:1.0, accuracy:0.65 },
    VC_RPG:     { id:'VC_RPG',     name:'RPG Team (B-40 Rocket)',   faction:'vc', hp:55,  atk:90, def:8,  spd:1.2, sight:4, noise:3.0, symbol:'P', hidden:true,  range:6, attackRate:0.35, accuracy:0.55, aoe:1.2 },
    VC_RPK:     { id:'VC_RPK',     name:'RPK Gunner (NVA/VC)',      faction:'vc', hp:65,  atk:20, def:12, spd:1.0, sight:4, noise:4.5, symbol:'K', hidden:false, range:3, attackRate:3.8, accuracy:0.48, burst:true },
    NVA_REG:    { id:'NVA_REG',    name:'PAVN Rifle Company',        faction:'vc', hp:100, atk:45, def:28, spd:1.4, sight:4, noise:2.0, symbol:'N', hidden:false, attackRate:1.4, accuracy:0.64 },
    NVA_HEAVY:  { id:'NVA_HEAVY',  name:'NVA Recoilless Rifle',     faction:'vc', hp:120, atk:75, def:22, spd:1.0, sight:3, noise:3.5, symbol:'W', hidden:false, range:5, attackRate:0.5, accuracy:0.68 },
